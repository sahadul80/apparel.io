        ...
        >
            ...
            >
                ...
                >
                    <a
                        href="/pages/shop"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg transition-all transform hover:scale-105 duration-300 text-sm shadow-xl"
                    >
                        Explore Collection
                    </a>
                    <a
                        href="/contact"
                        className="bg-gray-800 hover:bg-gray-700 text-white px-8 py-4 rounded-lg transition-all transform hover:scale-105 duration-300 text-sm shadow-xl"
                    >
                        Get in Touch
                    </a>
                </motion.div>
